        ...
        <Box display="flex" gap={{ xs: 4, lg: 6 }} flexDirection={{ xs: 'column', lg: 'row' }}>
          ...
          <Box flex={1}>
            ...
            <Typography gutterBottom>
              Hello! My name is Brittany and I enjoy creating things that live on the internet. My interest in web development started back
              in 2012 when I decided to try editing custom Tumblr themes — turns out hacking together a custom reblog button taught me a lot
              about HTML & CSS!
            </Typography>
            <Typography gutterBottom>
